...
[Insight]
- 2~4개 운영 축으로 작성
ㄴ 현황 설명이나 세부 수치 나열은 하지 말고, 데이터에서 도출된 인사이트(해석·판단)만 간결하게 작성
ㄴ 각 묶음의 첫 줄("-")에는 핵심 인사이트 한 문장만 담고, 수치 요약·현황 묘사는 넣지 마세요
ㄴ 근거 수치는 인사이트를 뒷받침하기 위해 꼭 필요한 경우에만 "ㄴ"에서 1개 정도로 최소화
ㄴ 성과의 원인·의미·시사점 위주로 짧게 작성하고, 같은 내용을 반복하지 마세요
